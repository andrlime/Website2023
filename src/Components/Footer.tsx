...
export const Footer: React.FC = () => {
  return (
    <div className='p-12 grid grid-cols-3 w-full bg-[#4E2A84] text-white pb-6'>
      <div className='text-left self-end'>
      <span className='font-bold'>©2023</span> Andrew Li
      </div>

      <div className='text-center flex justify-center align-middle self-end'>

        <a href='https://github.com/andrlime'><div className='rounded-full p-1 bg-[#836EAA] w-fit m-1 hover:cursor-pointer'><svg width={24} height={24} fill={"#FFF"}>
        ...
        <a href='https://www.linkedin.com/in/andrewli2048/'><div className='rounded-full p-1 bg-[#836EAA] m-1 font-black w-[32px] h-[32px] flex justify-center items-center hover:cursor-pointer'>in</div></a>
        <a href='mailto:andrewli@u.northwestern.edu'><div className='rounded-full p-1 bg-[#836EAA] m-1 font-black w-[32px] h-[32px] flex justify-center items-center hover:cursor-pointer'>✉️</div></a>
