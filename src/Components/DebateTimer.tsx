...
export const DebateTimer: React.FC = () => {
    ...
    return (
        <div className={`flex transition-all ease-in-out flex-col justify-center align-middle items-center h-[100vh] ${CURRENT_BG_COLOR}`}>
            <div className="flex flex-col sm:flex-row">
                {/* Show big timer */}
                <Timer time={currentTime} started={timerStarted} callback={(time: number) => {
                    if(time === 69000) setTimerStarted(false);
                    else if(time === 69001) {
